...
Within Unity Hub, add the directory `apps/zen-unity` to open the project within the Unity Editor. All of the dependencies described by `apps/zen-unity/quantum_unity/Packages/manifest.json` and `apps/zen-unity/quantum_unity/Assets/packages.config` will be installed.
